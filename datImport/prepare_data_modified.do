**This is the code to create the data for analysis from the original dataset provided in NBER or Harvard Dataverse. 

**The original datasets include:Data/oregonhie_survey12m_vars.dta, Data/oregonhie_descriptive_vars.dta, Data/oregonhie_stateprograms_vars.dta, Data/oregonhie_inperson_vars.dta, Data/oregonhie_ed_vars.dta

**We have added line 389-395 to merge the data with oregonhie_ed_vars (which includes information on healthcare charges prior to randomization). 
...
**************************
* Additional code to merge the data with oregonhie_ed_vars

merge 1:1 person_id using Data/oregonhie_ed_vars.dta
keep if _merge!=2
drop _merge

saveold data_for_analysis.dta, replace 